...
/* ============================================
   🔧 CORS ARREGLADO (FUNCIONA EN RENDER)
   ============================================ */
app.use(
  cors({
    origin: "*", // Permite cualquier origen (opción más simple)
    methods: ["GET", "POST", "PUT", "DELETE"],
    allowedHeaders: ["Content-Type", "Authorization"],
  })
);

// Necesario para las peticiones preflight OPTIONS
app.options("*", cors());
...
const songs = [
  ...
  { id: 10, name: "Ed Sheeran - Shape Of You (Dj Denis Rublev & Dj Anton remix)", artist: "Ed Sheeran", audio: "/music/Ed Sheeran - Shape Of You (Dj Denis Rublev & Dj Anton remix) Cmp3.eu.mp3" },
